...
console.clear()
console.log("\t\t\t*******************************\n")
console.log("\t\t\t*** BURGERCITY WHATSAPP BOT ***\n")
console.log("\t\t\t*******************************\n")
...
const listenMessage = () => {
    client.on('message', (msg) => {
        ...
        switch (body.toUpperCase()) {
            ...
            case "MÁS":
                sendMessage(from,
                " Nuestro sistema de envíos alcanza desde Bv Segui y Oroño hacia el centro, hace tu pedido desde la *carta digital* y un cadete llevará tus Burgers, estés donde estés! 🏍️" +
            ...
            case "FORMA DE PAGO": 
                ...
                "\n* ParavTake Away:* Efectivo, Transferencias bancarias y Billetera Santa Fe" +
...
/* installed:
whatsapp-web.js, qrcode-terminal (to generate sessions) */
